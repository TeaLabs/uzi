...
class Uzi
{
	...
	*/
	 ...
	 * Uzi::slice('fòôbàř', 0, 3, 'UTF-8'); translates to
	 * Str::create('fòôbàř', 'UTF-8')->slice(0, 3);
	 * The result is not cast, so the return value may be of type Str,
	 * integer, boolean, etc.
	 *
	 * @param string  $name
	 * @param mixed[] $arguments
	 *
	 * @return \Tea\Uzi\Str|mixed
	 *
	...
	public static function __callStatic($name, $arguments)
	{
		if (!static::$methodArgs) {
			$stringyClass = new ReflectionClass('Tea\Uzi\Str');
